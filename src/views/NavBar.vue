...
<template>
  <header class="navbar">
    <nav>
      <div class="nav-left">
        <router-link :to="{ name: 'home' }" class="logo">Garagem</router-link>
        <router-link :to="{ name: 'veiculos' }">Veiculos</router-link>
        <router-link :to="{ name: 'modelos' }">Modelos</router-link>
      </div>
